...
class EntrustSetupTables extends Migration
{
    ...
    public function up()
    {
        ...
        // Create table for storing sys_roles
        ...
        // Create table for associating sys_roles to users (Many-to-Many)
        ...
        // Create table for storing sys_permissions
        ...
        // Create table for associating sys_permissions to sys_roles (Many-to-Many)
