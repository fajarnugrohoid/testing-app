				...
				<div class="sixteen wide field">
					...
					<div class="ui small input">
						<select id="pendidikan" name="angkakredit_id[]" class="ui fluid search selection dropdown pilihan pendidikan" disabled="">
							{!! 
								\App\Models\Master\AngkaKredit::options('nama', 'id', [
									'filters' => ['kategori_id' => 1]
								])
							!!}
						</select>
			...
			<div class="fields">
				<div class="sixteen wide field">
					<div class="ui small input">
						...
						<input type="hidden" id="prajabatan_angkakredit_id" name="angkakredit_id[]" value="{{ $prajabatan->id }}" disabled="">
						<input type="hidden" id="prajabatan_angkakredit_nilai" name="angkakredit_nilai[]" value="{{ $prajabatan->nilai }}" disabled="">
