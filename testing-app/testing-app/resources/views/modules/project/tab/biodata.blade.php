		...
		<div class="ui form">
			<div class="fields">
				...
				<div class="eight wide field">
					...
					<div class="ui small input">
						...
						<input type="text" name="nik" value="" readonly>
					</div>
				</div>
			</div>
			<div class="fields">
			...
			<div class="fields">
				<div class="ten wide field">
					...
					<div class="ui small input">
						<input type="text" name="tmp_lahir" value="">
					</div>
				</div>
				<div class="six wide field">
						...
						<div class="ui small input left icon">
							...
							<input type="text" name="tgl_lahir"  value="" autocomplete="off">
						</div>
					</div>
				</div>	
			</div>
		...
		<div class="ui form">
			...
			<div class="fields">
				<div class="sixteen wide field">
					...
					<div class="ui small input">
						<textarea rows="4" readonly="readonly" id="alamat_unit_kerja"></textarea>
					</div>
				</div>
			</div>
			...
			<div class="fields">
				...
				<div class="four wide field">
					<label>TMT</label>
						...
						<div class="ui small input left icon">
							<i class="calendar icon"></i>
							<input type="text" name="tmt_golongan" value="" autocomplete="off">
						</div>
					</div>
				</div>
			</div>
