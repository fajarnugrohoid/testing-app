    ...
    public function makeButton($params = [])
    {
        ...
        switch ($params['type']) {
            ...
            case "delete":
                ...
                {$datas}{$attrs}{$extends} class='ui mini {$params['class']} button' {$params['disabled']}>{$params['label']}</button>\n";
                break;
            case "edit":
            ...
            case "modal":
                ...
                $btn = "<button type='button' {$datas}{$attrs}{$extends} class='ui mini {$params['class']} button' {$params['disabled']} onclick='{$params['onClick']}'>{$params['label']}</button>\n";
                break;
            case "print":
            ...
            default:
                ...
                $btn = "<a href='{$params['url']}' {$datas}{$attrs}{$extends} class='ui mini {$params['class']} button {$params['disabled']}'  onclick='{$params['onClick']}' target='{$params['target']}'>{$params['label']}</a>\n";
        }
